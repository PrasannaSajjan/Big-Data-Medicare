...
1) echo "Output for Cardiovascular stress test with hcpcs code 93015";
	...
	/opt/hadoop-2.5.1/bin/hadoop fs -rm -r -f /user/psajjan/output

	pig project_update_93015.pig 

	/opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output/part-r-00000 $pwds/$dir1
...
2) echo "Output to get the count of records before and after the join with hcpcs code 93015";
	...
	/opt/hadoop-2.5.1/bin/hadoop fs -rm -r -f /user/psajjan/output1
	/opt/hadoop-2.5.1/bin/hadoop fs -rm -r -f /user/psajjan/output2
	/opt/hadoop-2.5.1/bin/hadoop fs -rm -r -f /user/psajjan/output3

	pig project_count_93015.pig

	/opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output1/part-r-00000 $pwds/$dir3
	/opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output2/part-r-00000 $pwds/$dir4
	/opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output3/part-r-00000 $pwds/$dir5
...
3) echo "Graduate part execution starts here";
	...
	/opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output/part-r-00000 $pwds/$dir2
...
4) echo "Output to get the count of records before and after the join with hcpcs code 93010";
        ...
        /opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output1/part-r-00000 $pwds/$dir6
        /opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output2/part-r-00000 $pwds/$dir7
        /opt/hadoop-2.5.1/bin/hadoop fs -copyToLocal /user/psajjan/output3/part-r-00000 $pwds/$dir8
...
echo "Press Y if you want to continue data extraction";
